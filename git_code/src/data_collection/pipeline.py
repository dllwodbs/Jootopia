...
class DataCollectionPipeline:
    ...
    def __init__(
        ...
        self.raw_data_dir = Path(get_path(self.cfg, "data_raw_data"))
        self.cal_data_dir = Path(get_path(self.cfg, "data_cal"))
        self.raw_data_dir.mkdir(parents=True, exist_ok=True)
        self.cal_data_dir.mkdir(parents=True, exist_ok=True)
    ...
    def run_l0(self) -> pd.DataFrame:
        ...
        cache_path = self.raw_data_dir / "universe_k200_membership_monthly"
    ...
    def run_l1(self) -> pd.DataFrame:
        ...
        cache_path = self.raw_data_dir / "ohlcv_daily"
    ...
    def run_l2(self) -> Optional[pd.DataFrame]:
        ...
        cache_path = self.raw_data_dir / "fundamentals_annual"
    ...
    def run_l3(self) -> pd.DataFrame:
        ...
        cache_path = self.cal_data_dir / "panel_merged_daily"
    ...
    def run_l4(self) -> dict[str, any]:
        ...
        dataset_path = self.cal_data_dir / "dataset_daily"
        cv_short_path = self.cal_data_dir / "cv_folds_short"
        cv_long_path = self.cal_data_dir / "cv_folds_long"
